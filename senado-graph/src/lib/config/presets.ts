...
export const presets: FilterPreset[] = [
  {
    ...
    descriptionEs: 'Visualice cómo los partidos votan de manera diferente e identifique los límites entre partidos',
    descriptionEn: 'Visualize how parties vote differently and identify party boundaries',
    filters: {
  ...
  },
  {
    ...
    descriptionEs: 'Encuentre senadores que colaboran a través de las líneas partidistas a pesar de diferentes afiliaciones',
    descriptionEn: 'Find senators who collaborate across party lines despite different affiliations',
    filters: {
      entityTypes: ['senator', 'party'],
      relationshipTypes: ['belongs_to', 'voted_same'],
  ...
  },
  {
    ...
    descriptionEs: 'Identifique los senadores más influyentes a través de leyes autorizadas, comités y conexiones',
    descriptionEn: 'Identify most influential senators through authored laws, committees, and connections',
    filters: {
  ...
  },
  {
    ...
    descriptionEs: 'Muestre patrones de colaboración a través de la autoría de leyes y patrones de votación',
    descriptionEn: 'Show collaboration patterns through law authorship and voting patterns',
    filters: {
